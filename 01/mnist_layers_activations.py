...
class Network:
    ...
    def evaluate(self, dataset, images, labels):
        return self.session.run([self.summaries[dataset],self.accuracy], {self.images: images, self.labels: labels})
...
if __name__ == "__main__":
    ...
    results=network.evaluate("test", mnist.test.images, mnist.test.labels)
